...
def linuxConfig():
    ...
    os.system("To see which libraries are to be installed, check")
    os.system("echo [93mrequirements.txt [97mand to see which lines of code")
    os.system("are being executed, look at the [93mlinuxConfig.py [97mfile.\)")
